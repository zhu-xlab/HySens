...
def load_barbara_wavelengths():
    barbara_wavelength = np.linspace(400, 2500, 224, dtype=np.float32)
    return barbara_wavelength


class BarbaraDataset(Dataset):
...
def create_data_loaders_barbara(dataset, batch_size):
