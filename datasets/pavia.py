...
def load_pavia_wavelengths():
    hs_wavelength_pavia = np.linspace(430, 860, 103, dtype=np.float64)
    return hs_wavelength_pavia
...
class PaviaDataset(Dataset):
    ...
    def __init__(self, data_dir, label_dir, harmonizer, patch_size):
        ...
        self.image = image_data['paviaU']
        self.label = label_data['paviaU_gt']
...
def create_data_loaders_pavia(dataset, batch_size):
