...
def load_whuhh_wavelengths():
    hs_wavelength_whu = np.linspace(400, 1000, 270, dtype=np.float64)
    return hs_wavelength_whu


class WHUHH_Dataset(Dataset):
...
def create_data_loaders_whuhh(dataset, batch_size):
